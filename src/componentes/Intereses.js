    ...
    return ( 
        <section class="p-3 p-lg-5 d-flex align-items-center" id="interests">
            <div class="w-100">
                ...
                <h4><i class="fas fa-file-signature"></i><a style={{color: '#007bff'}} href="https://www.linkedin.com/posts/martintg_mi-2019-activity-6613537213747728384-NkRI">{messages.interests_info}</a></h4>
            </div>
        </section>
     );
}
